petunjuk = {
    ...
    "menu 1": {
        ...
        "desain": [
            ...
            "memiliki tampilan laya utama yaitu tabel yang mepresentasikan data siswa seperti nomor absen, nomor induk, nama siswa, jenis kelamin, keterangan kehadir siswa",
